 ...
 * @since 3.10.0
 */
class InspectText extends Base_Data_Control
{
    /**
    ...
    {
        return 'beyondwords_inspect_text';
    }
    ...
    public function content_template()
    {
        ...
        <div class="elementor-control-field">
            ...
            <div class="elementor-control-input-wrapper elementor-control-unit-5 elementor-control-dynamic-switcher-wrapper">
                <input id="<?php $this->print_control_uid(); ?>" type="{{ data.input_type }}" readonly disabled class="tooltip-target elementor-control-tag-area" data-tooltip="{{ data.title }}" title="{{ data.title }}" data-setting="{{ data.name }}" placeholder="{{ view.getControlPlaceholder() }}" />
            </div>
        </div>
        <# if ( data.description ) { #>
