...
namespace BeyondWords\Editor\Components\ErrorNotice;
...
class Assets {
	...
	public static function enqueue_block_assets(): void {
		...
		wp_enqueue_style(
			'beyondwords-error-notice',
			BEYONDWORDS__PLUGIN_URI . 'src/editor/components/error-notice/error-notice.css',
			[],
