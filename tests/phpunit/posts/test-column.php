...
class ColumnTest extends TestCase
{
    ...
    public function test_render_columns_head()
    {
        $defaults = ['foo' => 'Bar'];
    ...
    /**
     * @dataProvider render_columns_content_provider
     */
    public function test_render_columns_content(string $expect, array $postArgs)
    {
    ...
    public function render_columns_content_provider()
    {
        return [
     ...
     * @test
     *
     * @dataProvider make_column_sortable_provider
     **/
    ...
    public function make_column_sortable_provider()
    {
        return [
            'Empty params' => [
                'expect' => [
