...
class UninstallerTest extends TestCase
{
     ...
     * @test
     *
     * @dataProvider option_names_provider
     */
    public function cleanup_plugin_options($name)
    {
     ...
     * @test
     */
    public function cleanup_custom_fields()
    {
        $numPosts = 10;
     ...
     * @test
     */
    public function cleanup_plugin_transients_removes_beyondwords_transients_only()
    {
        global $wpdb;
