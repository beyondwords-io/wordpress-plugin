...
use BeyondWords\Editor\Components\AddPlayer;
...
class AddPlayerTest extends TestCase
{
    ...
    {
        $url = BEYONDWORDS__PLUGIN_URI . 'src/editor/components/add-player/tinymce.js';
    ...
    {
        $url = BEYONDWORDS__PLUGIN_URI . 'src/editor/components/add-player/add-player.css';
